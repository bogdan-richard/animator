package com.animations.indanimator.actions.arc;
...
/**
 * {@link BaseAction} that translate with curve.
 */
public class CurveAction extends BaseAction {
    ...
    public void animate(View view) {
        final ObjectAnimator anim =
                ObjectAnimator.ofObject(this, PATH_POINT_LOCATION,
    ...
    public void setPathPointLocation(final PathPoint newLoc) {
        ViewCompat.setTranslationX(getView(), newLoc.mX);
        ViewCompat.setTranslationY(getView(), newLoc.mY);
    }
